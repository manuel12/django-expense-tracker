...
class ExpenseModelManagerTests(TestCase):
  ...
  def setUp(self):
      ...
      self.total_expenses = (self.todays_expenses 
  ...
  def test_statistics_current_month_expense_sum(self):
      ...
      for month_date in utils.daterange(month_dates['first_day'], month_dates['last_day']):
      ...
      self.assertEqual(self.statistics['curr_month_expense_sum'], current_month_expenses_sum)
  ...
  def test_statistics_last_month_expense_sum(self):
      ...
      self.assertEqual(self.statistics['one_month_ago_expense_sum'], one_month_ago_expense_sum)
