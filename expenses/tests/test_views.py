...
class SingupPageTests(TestCase):
  ...
  def test_signuppage_url_resolves_signuppage_view(self):
      ...
      self.assertEqual(
          view.func.__name__,
          account_views.signup_view.__name__
      )
...
class UpdateExpenseTest(TestCase):
  ...
  def setUp(self):
      ...
      self.client.force_login(self.user)
      self.response = self.client.get(reverse('expenses:update', kwargs={'pk': self.test_expense.pk}))

  def test_redirect_if_not_logged_in(self):
      c = Client()
      response = c.get(reverse('expenses:update', kwargs={'pk': self.test_expense.pk}))
      self.assertEqual(response.status_code, 302)
  ...
  def test_updatepage_url_resolves_homepage_view(self):
      ...
      self.assertEqual(
          view.func.__name__,
          views.update_expense.__name__
      )

  def test_updatepage_post_action(self):
      response = self.client.post(reverse('expenses:update', kwargs={'pk': self.test_expense.pk}), {
...
class DeleteExpenseTest(TestCase):
  ...
  def setUp(self):
      ...
      self.client.force_login(user)
      self.response = self.client.get(reverse('expenses:delete', kwargs={'pk': self.test_expense.pk}))

  def test_redirect_if_not_logged_in(self):
      c = Client()
      response = c.get(reverse('expenses:delete', kwargs={'pk': self.test_expense.pk}))
      self.assertEqual(response.status_code, 302)
  ...
  def test_deletepage_url_resolves_deletepage_view(self):
      ...
      self.assertEqual(
          view.func.__name__,
          views.delete_expense.__name__
      )

  def test_deletepage_post_action(self):
      response = self.client.post(reverse('expenses:delete', kwargs={'pk': self.test_expense.pk}))
      self.assertEqual(response.status_code, 302)
...
class UpdateBudgetTest(TestCase):
  ...
  def setUp(self):
      ...
      self.response = self.client.get(reverse('expenses:update_budget'), kwargs={'pk': self.test_budget.pk})
  ...
  def test_update_budgetpage_url_resolves_update_budgetpage_view(self):
      ...
      self.assertEqual(
          view.func.__name__,
          views.update_budget.__name__
      )

  def test_update_budgetpage_post_action(self):
    self.client.post(reverse('expenses:update_budget'), {
