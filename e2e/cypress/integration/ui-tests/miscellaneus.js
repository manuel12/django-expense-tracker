...
describe("Miscellanus Tests", () => {
  ...
  it("should display pagination buttons when more than 10 expenses are added", function () {
  ...
  it("should display second page of pagination", function () {
  ...
  it("should display charts once expenses have been added", function () {
  ...
  it.skip("+Add Expense button should have focus", function () {
    cy.visit("/");
    cy.get("[data-test=add-expense]").should("be.visible").and("have.focus");
  });
});
